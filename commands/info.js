...
.addField('Turn the Page!', 'To turn the page, react to this message with `▶`.'),
    new Discord.MessageEmbed().setColor('#750384').setTitle('(#2) Team Commands').setDescription(`To see info about all the commands, use b-help. To see info about a specific command, use b-help [command]. Upon joining, the bot will automatically assign you a team and you can get started! Here's a bit of info about the specific commands:`).addFields({
      name: `\`b-read [times]\``,
